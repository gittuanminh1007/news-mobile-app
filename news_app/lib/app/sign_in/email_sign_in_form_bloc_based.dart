...
import 'package:news_app/app/sign_in/email_sign_in_bloc.dart';
import 'package:news_app/common_widgets/form_submit_button.dart';
import 'package:news_app/common_widgets/show_exception_alert_dialog.dart';
import 'package:news_app/models/email_sign_in_model.dart';
  ...
  List<Widget> _buildChildren(EmailSignInModel model) {
    return [
      ...
      TextButton(
        ...
        child: Text(model.seccondButtonText),
      ),
    ];
  }
